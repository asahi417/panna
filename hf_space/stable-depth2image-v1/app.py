...
repo = "stabilityai/stable-diffusion-2-depth"
if torch.cuda.is_available():
    pipe = StableDiffusionDepth2ImgPipeline.from_pretrained(repo, torch_dtype=torch.float16).to("cuda")
else:
    pipe = StableDiffusionDepth2ImgPipeline.from_pretrained(repo)
