...
output = model.text2image(
    [img], depth_maps=depth, prompt=["a black cat"], negative_prompt=["bad, deformed, ugly, bad anatomy"]
)
elapsed = time() - start
print(f"{elapsed} sec")
save_image(output[0], "./test/test_images/sample.depth2image_depth_anything.png")
